...
description: Saiba como transformar suas ideias em um storyboard automaticamente usando prompts de texto
...
# Construtor de storyboards

Saiba como transformar suas ideias em um storyboard automaticamente usando prompts de texto. Construa cena por cena, adicionando um nó por batida da narrativa. Reordene os nós para testar uma sequência diferente antes de bloquear a ordem final dos painéis. [Abra o modelo do Construtor de Storyboard](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:962af654-f338-58eb-ac9a-3ce151c2f4bc).
