---
title: Texto para Storyboard
description: Saiba como gerar um storyboard a partir de um script ou de uma lista de tomadas
...
# Texto para storyboard

Saiba como gerar um storyboard a partir de um script ou de uma lista de tomadas. Cada linha se torna seu próprio quadro de storyboard, gerado em sequência e disposto para revisão como um único conjunto de painéis. [Abrir Texto no modelo de storyboard](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:8c4d6b7f-a9b6-503c-8a7e-c06cb5cc4ce2).
