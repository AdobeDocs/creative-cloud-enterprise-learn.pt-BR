---
title: Geração de modelo de caractere
description: Saiba como criar um estilo animado 3D de uma ilustração
...
# Geração de modelo de caractere

Saiba como criar um estilo animado 3D de uma ilustração. O modelo gera uma passagem de modelo 3D base pronta para ser entregue a um modelador para limpeza, em vez de iniciar a partir de uma cena em branco.[Abra o modelo de geração de modelo de caractere](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:4008fbc8-083b-5766-ace9-6abf998df840).
