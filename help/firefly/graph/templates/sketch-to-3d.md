---
title: Converter esboço em 3D
description: Saiba como transformar um esboço em um caractere 3D
...
# Transformação de Sketch em 3D

Saiba como transformar um esboço em um caractere 3D. O gráfico cria um giro 3D giratório a partir dele, pronto para uma revisão interna de design antes de qualquer protótipo físico. [Abra o Sketch para um modelo de resposta 3D](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:984a5ded-67e1-5a78-9283-52a0126bf8b2).
...
* **Entretenimento** - Transforme um esboço do conceito do personagem em uma reviravolta 3D para uma apresentação.
